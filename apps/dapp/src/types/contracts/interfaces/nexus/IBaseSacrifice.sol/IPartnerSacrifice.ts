...
export interface IPartnerSacrificeInterface extends utils.Interface {
  functions: {
...
export interface IPartnerSacrifice extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: IPartnerSacrificeInterface;
