...
import borderFrame from 'assets/images/nexus/PotSlideBorderFrame.png';
import headerImage from 'assets/images/nexus/PotSlideHeader.png';
...
const PotSlide: React.FC<SlideProps> = ({ headerText, children }) => {
  return (
    <SlideContainer>
      <SlideHeader>
